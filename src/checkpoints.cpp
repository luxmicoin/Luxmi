...
namespace Checkpoints
{
    ...
    // Luxmi: synchronized checkpoint (centrally broadcasted)
    ...
    // Luxmi: get last synchronized checkpoint
    ...
    // Luxmi: only descendant of current sync-checkpoint is allowed
    ...
    // Luxmi: reset synchronized checkpoint to last hardened checkpoint
...
// Luxmi: sync-checkpoint master key
...
// Luxmi: verify signature of sync-checkpoint message
...
// Luxmi: process synchronized checkpoint
