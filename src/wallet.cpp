...
// Luxmi: total coins staked (non-spendable until maturity)
...
// Luxmi: get current stake weight
...
// Luxmi: check 'spent' consistency between wallet and txindex
// Luxmi: fix wallet spent state according to txindex
...
// Luxmi: disable transaction (only for coinstake)
